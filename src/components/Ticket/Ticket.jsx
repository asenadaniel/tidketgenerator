  ...
  return (
    <div className=' bg-[url(./assets/desktop.png)] bg-cover bg-center h-screen  flex flex-col text-white items-center  m-auto'>
      ...
      <div className=' md:mt-[160px] mt-[70px]  '>
        ...
        <div className=' bg-pink-200/20 backdrop-blur-lg  border-pink-300 border w-[385px] md:w-[480px]  text-white  hover:bg-pink-300/20 transition flex flex-col items-center justify-start cursor-pointer md:pr-[200px] pl-3 h-[200px] pr-[130px] ' >
